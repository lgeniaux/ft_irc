...
/*   Updated: 2023/12/14 15:22:34 by jcollon          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "Command.hpp"

Channel* CommandHandler::preChecks(const std::string nickname, int client_fd, Server &server, const bool needOp)
{
	Channel *channel;
